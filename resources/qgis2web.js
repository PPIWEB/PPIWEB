...
map.getView().fit([-6608046.175047, -3177942.544359, -5587600.086216, -2656598.683806], map.getSize());
...
function createPopupField(currentFeature, currentFeatureKeys, layer) {
    ...
    autolinker.link(Number(currentFeature.get(currentFeatureKeys[i])).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})) + '</td>' : '');
			} else {
