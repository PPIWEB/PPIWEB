...
map.getView().fit([-6286974.336401, -2812031.838196, -6259158.043848, -2795922.471404], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WEB_MAP_PARAGUAY (QFieldCloud)</h2>';
        return titleElement;
    })(),
