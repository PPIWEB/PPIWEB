...
// --- INICIO DEL PARCHE MEJORADO PARA MÓVILES ---
    input.addEventListener('input', function() {
        // Creamos un evento de teclado simulado
        var fakeEvent = new KeyboardEvent('keyup', { 
            bubbles: true, 
            cancelable: true 
        });
        
        // Forzamos un código de tecla que la librería sí reconozca (65 = letra 'A')
        // Esto salta la restricción del código 229 en Android/iOS
        Object.defineProperty(fakeEvent, 'keyCode', { get: function() { return 65; } });
        Object.defineProperty(fakeEvent, 'which', { get: function() { return 65; } });
