...
lyr_PARAGUAYPROPIEDADES_3.set('fieldAliases', {'ID': 'ID', 'Manzana': 'Manzana', 'Lote': 'Lote', 'Superficie': 'Superficie', 'Estado': 'Estado', 'Cuota': 'Cuota', 'Total': 'Total', 'Descuento': 'Descuento', 'Contado': 'Contado', 'Entrega': 'Entrega', });
lyr_MANZANAS_4.set('fieldAliases', {'id': 'id', });
lyr_FRACCION_1.set('fieldImages', {'FRACCION': 'TextEdit', });
lyr_F_2.set('fieldImages', {'F': 'TextEdit', });
lyr_PARAGUAYPROPIEDADES_3.set('fieldImages', {'ID': 'TextEdit', 'Manzana': 'TextEdit', 'Lote': 'TextEdit', 'Superficie': 'TextEdit', 'Estado': 'TextEdit', 'Cuota': 'TextEdit', 'Total': 'TextEdit', 'Descuento': 'TextEdit', 'Contado': 'TextEdit', 'Entrega': 'TextEdit', });
...
lyr_PARAGUAYPROPIEDADES_3.set('fieldLabels', {'ID': 'hidden field', 'Manzana': 'header label - always visible', 'Lote': 'header label - always visible', 'Superficie': 'header label - always visible', 'Estado': 'header label - visible with data', 'Cuota': 'header label - always visible', 'Total': 'header label - always visible', 'Descuento': 'header label - always visible', 'Contado': 'header label - always visible', 'Entrega': 'header label - always visible', });
