var size = 0;
var placement = 'point';
function categories_COMBINADO_4(feature, value, size, resolution, labelText,
...
var style_COMBINADO_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Lote") !== null && resolution > 0 && resolution < 0) {
        labelText = String(feature.get("Lote"));
    }
    
    var style = categories_COMBINADO_4(feature, value, size, resolution, labelText,
