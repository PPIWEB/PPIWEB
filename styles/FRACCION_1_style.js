...
var style_FRACCION_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "19.5px \'Sitka Small Semibold\', sans-serif";
    var labelFill = "#00f9ff";
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("FRACCION") !== null) {
            labelText = String(feature.get("FRACCION"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(251,0,0,1.0)'})}),
