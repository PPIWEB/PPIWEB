var size = 0;
var placement = 'point';
function categories_2RESIDENCIALGUILLERMINA_37(feature, value, size, resolution, labelText,
...
default:
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.575)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(255,255,255,0.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_2RESIDENCIALGUILLERMINA_37 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_2RESIDENCIALGUILLERMINA_37(feature, value, size, resolution, labelText,
